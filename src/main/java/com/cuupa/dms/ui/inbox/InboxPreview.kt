...
import com.cuupa.dms.ui.archive.VersionsLayout
...
class InboxPreview(@Autowired val camundaService: CamundaService, @Autowired val accessControl: AccessControl,
